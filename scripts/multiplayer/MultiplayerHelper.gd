...
var _level_spawner: MultiplayerSpawner
...
func _on_connected_ok():
	...
	# ensure the peer id we have set is the correct one once we
	# successfully connect
	local_player_info.id = peer_id
